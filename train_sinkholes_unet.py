...
def train_model(
    ...
    image_dir = args.patches_dir + 'data_patches_H' + str(H) + '_W' + str(W) +'strpp_'+str(args.stride) + ('_11days' if args.train_on_11d_diff else '')
    mask_dir = args.patches_dir + 'mask_patches_H' + str(H) + '_W' + str(W)  +'strpp_'+str(args.stride) + ('_11days' if args.train_on_11d_diff else '')
    #
